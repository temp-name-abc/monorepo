...
export function useBillingEnabled(product: IProduct) {
    ...
    useQuery([KEY_PORTAL, product], () => getPortal(token as string, product), {
        ...
        onSuccess: (portal) =>
            !portal.active &&
            setNotification({
                title: "Billing has not been enabled for this feature",
                description:
                    "You have not enabled billing for this feature and your access may be restricted. To fix this, navigate to the 'Billing' tab and enable the feature.",
                severity: "warning",
            }),
    });
}
